namespace Maroontress.Html.Impl
{
    ...
    /// <summary>
    /// The abstract visitor implementaion to write the HTML document into
    /// text.
    /// </summary>
    public abstract class AbstractTextWriterVisitor : NodeVisitor
    {
        ...
        /// <summary>
        /// The hook to write the start tag, which is invoked just before the
        /// tag starts. The method overriding this method must invoke
        /// <see cref="WriteStartTag(in TagStruct)"/> with the specified tag.
        /// </summary>
        /// <param name="tag">
        /// The tag.
        /// </param>
        ...
        /// <summary>
        /// The hook to write the end tag, which is invoked just before the
        /// tag ends. The method overriding this method must invoke
        /// <see cref="WriteEndTag(in TagStruct)"/> with the specified tag.
        /// </summary>
        /// <param name="tag">
        /// The tag.
        /// </param>
