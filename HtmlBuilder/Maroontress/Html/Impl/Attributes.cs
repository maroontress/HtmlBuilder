...
public static class Attributes
{
    ...
    /// </summary>
    /// <remarks>
    /// Refer sections "2.4.1. Common parser idioms" of the <a
    /// href="https://www.w3.org/TR/html52/">HTML 5.2</a>.
    /// <blockquote>
    ...
    /// The function that takes the attribute name and returns whether the name
    /// is duplicated.
    /// </param>
        ...
        IEnumerable<(string Name, string? Value)> attributes)
    {
        ...
        var selfDuplicatedKey = keys.GroupBy(k => k)
            ...
            .Select(g => g.Key)
            .FirstOrDefault();
        if (selfDuplicatedKey is not null)
        {
            throw new ArgumentException(
    ...
    /// <summary>
    /// Gets the whether the spcified name is valid for HTML attribute names.
    /// </summary>
    /// <param name="name">
    ...
    /// <summary>
    /// Gets the whether the spcified value is not empty and contains no space
    /// characters.
    /// </summary>
    /// <param name="value">
    ...
    /// state" of the <a href="https://www.w3.org/TR/html52/">HTML 5.2</a>. The
    /// former describes that the attribute name can consist of U+003C
    /// LESS-THAN SIGN (&lt;) as follows:
    /// <blockquote>
